...
abstract class StudentRecordToFile extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\StudentRecordToFileQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\StudentRecordToFileQuery(get_called_class());
    }
