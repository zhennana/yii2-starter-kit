...
class QiniuActions extends Action
{
    ...
    protected function createToken()
    {
        ...
        // $key = $_FILES['Courseware']['name']['image'];
        // $filePath  = $_FILES['Courseware']['tmp_name']['image'];
        $err = NULL;
        $ret =[
          'name'=>  "banner5.jpg",
          'size'=>'579739',
        ...
        if ($err !== null) {
          var_dump($err);exit;
           ...
           $image = \Yii::$app->params['qiniu'][$this->bucket]['domain'].'/'. $ret['name'];
            return Yii::$app->response->data=[
                        ...
                        'initialPreviewConfig'=>[
                               // 'caption'=>$ret['key'],
                               'width'  =>'120px',
                               'url'    => Url::to(['/courseware/delete-cloud']),
                               'key'    =>$ret['key'],
                        ],
                        'append' => false,
