...
class QiniuArticleAction extends Action
{
    public $type = 'upload';
    ...
    {
        // ArticleAttachment();
        $file = new ArticleAttachment();
        $file->article_id      = Yii::$app->request->post('article_id');
        ...
        // $file->component    = 'qiniuStorage';

        $data['errno']=0;
        $data['message']='';
// var_dump($file->upload_ip,$file->save(false)); exit();
        if($file->article_id && $file->save(false)){
