        ...
        */
        'payment' => [
            'gedu' => [
                ...
                //商户私钥，您的原始格式RSA私钥
                'merchant_private_key' => Yii::getAlias('@common').'\payment\alipay\cert\gedu\gedu_rsa_private_key.pem',
                ...
                'alipay_public_key' => Yii::getAlias('@common').'\payment\alipay\cert\gedu\alipay_public_key.pem',
                ],
            ],
        ],
