...
$this->title = Yii::t('backend', 'StudentRecord');
...
<div class="giiant-crud student-record-view">
    ...
    <h1>
        <?= Yii::t('backend', 'StudentRecord') ?>        <small>
            <?= $model->title ?>        </small>
    </h1>
    ...
    <?php $this->beginBlock('common\models\school\StudentRecord'); ?>
    ...
    'content' => $this->blocks['common\models\school\StudentRecord'],
    'active'  => true,
], ]
                 ]
    );
