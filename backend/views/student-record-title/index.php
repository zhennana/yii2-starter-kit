...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var common\models\search\StudentRecordTitleSearch $searchModel
*/
...
if (\Yii::$app->user->can('backend_student-record-title_view')) { 
    $actionColumnTemplates[] = '{view}';
}

if (\Yii::$app->user->can('backend_student-record-title_update')) {
    $actionColumnTemplates[] = '{update}';
}

if (\Yii::$app->user->can('backend_student-record-title_delete')) {
...
<div class="giiant-crud student-record-title-index">
    ...
    <h1>
        <?= Yii::t('backend', 'StudentRecordTitles') ?>        <small>
            List
        </small>
    </h1>
    <div class="clearfix crud-navigation">
<?php
if(\Yii::$app->user->can('backend_student-record-title_create')){
?>
        <div class="pull-left">
