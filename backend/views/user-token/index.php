 ...
 * @var common\models\search\UserTokenSearch $searchModel
 */
$this->title = Yii::t('models', 'User Tokens');
...
?>
<div class="giiant-crud user-token-index">
...
?>
    ...
    <h1>
        <?php echo Yii::t('models', 'User Tokens') ?>
        <small>
            List
        </small>
    </h1>
...
<?php
if (\Yii::$app->user->can('backend_user-token_create', ['route' => true])) {
?>
        <div class="pull-left">
