...
/**
 * CoursewareToFileSearch represents the model behind the search form about `backend\modules\campus\models\CoursewareToFile`.
 */
class CoursewareToFileSearch extends CoursewareToFile
{
	...
	public function rules() {
		return [
			[['courseware_to_file_id', 'file_storage_item_id', 'courseware_id', 'status', 'sort', 'updated_at', 'created_at'], 'integer'],
		];
	}
