...
public function behaviors()
    ...
    if($storage['message']['file_storage_item_id'] && $this->courseware_id){
        $courseware_to_file  =   $this->addCoursewareToFile($storage['message']['file_storage_item_id'],$this->courseware_id);
    ...
    public function QiniuUpload($file){
      ...
      *课件关系表入库
      */
     public function addCoursewareToFile($storage_id,$courseware_id){
            $info = [
                'errorno'=>0,
                'error'  =>'',
                'message'=>''
            ...
            $model->file_storage_item_id = $storage_id;
    ...
    public function AddStorage($qinniu_file){
        ...
        $model->type      = $qinniu_file['type'];
        $model->size      = $qinniu_file['size'];
        $model->file_name = $qinniu_file['key'];
