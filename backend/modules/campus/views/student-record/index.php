...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\campus\models\search\StudentRecordSearch $searchModel
*/
...
if (\Yii::$app->user->can('campus_student-record_view', ['route' => true])) {
    $actionColumnTemplates[] = '{view}';
}

if (\Yii::$app->user->can('campus_student-record_update', ['route' => true])) {
    $actionColumnTemplates[] = '{update}';
}

if (\Yii::$app->user->can('campus_student-record_delete', ['route' => true])) {
...
<?php
if(\Yii::$app->user->can('campus_student-record_create', ['route' => true])){
?>
        <div class="pull-left">
