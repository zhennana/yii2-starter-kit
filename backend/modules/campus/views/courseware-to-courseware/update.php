 ...
 */
$this->title = Yii::t('backend', 'Courseware To Courseware') . " " . $model->courseware_to_courseware_id . ', ' . Yii::t('backend', 'Edit');
...
<div class="giiant-crud courseware-to-courseware-update">
    ...
    <div class="crud-navigation">
        <?php echo Html::a('<span class="glyphicon glyphicon-file"></span> ' . Yii::t('backend', 'View'), ['view', 'courseware_to_courseware_id' => $model->courseware_to_courseware_id], ['class' => 'btn btn-default']) ?>
    </div>
