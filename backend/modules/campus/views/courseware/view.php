                ...
                'columns'=>[
                    ...
                    [
                        ...
                        'value' => function($model, $key, $index, $grid){
                            ...
                            }elseif(strstr($model->fileStorageItem->type = 'o_1bil7rau811nngqouui1b6gqr69.mp4','mp4')){
                                return Html::a($model->fileStorageItem->file_name, ['courseware/video','files'=>$model->fileStorageItem->file_name = 'o_1bil7rau811nngqouui1b6gqr69.mp4'] ,[
                                    'title'=>'访问',
                                    'target'=>'_blank'
                                    ]);
                            }else{
