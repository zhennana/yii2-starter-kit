...
if (\Yii::$app->user->can('campus_courseware_view', ['route' => true])) {
    $actionColumnTemplates[] = '{view}';
}

if (\Yii::$app->user->can('campus_courseware_update', ['route' => true])) {
    $actionColumnTemplates[] = '{update}';
}

if (\Yii::$app->user->can('campus_courseware_delete', ['route' => true])) {
...
<?php
if(\Yii::$app->user->can('campus_courseware_create', ['route' => true])){
?>
        <div class="pull-left">
