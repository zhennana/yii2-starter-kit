<?php
    $a = Yii::getAlias('@common/widgets/pdf/web/viewer.css');
   //  var_dump($a);exit;
?>
<!DOCTYPE html>
...
<script src="../../../../common/widgets/pdf/web/viewer.js"></script>
  ...
  <body tabindex="1" class="loadingInProgress" onselectstart="return false">
...
<script type="text/javascript">
    ...
    var insertMobile =  function(){
        ...
        for(var i = 0; i < textLayerDivs.length; i++){
            var mobile  = document.createElement('div');
            mobile.style.float =  'left';
            mobile.style.fontSize = '35px';
            mobile.style.color = 'red';
            mobile.innerHTML = tel;
            textLayerDivs[i].appendChild(mobile);
        }

    }
    setTimeout(insertMobile,2000);
     //inserMobile();
    function Click(){
        //console.log(event);
        if (event.button == 2){
