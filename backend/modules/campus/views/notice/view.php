...
?>
<div class="giiant-crud notice-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            [ 'update', 'notice_id' => $model->notice_id],
            ['class' => 'btn btn-info']) ?>

            <?= Html::a(
            '<span class="glyphicon glyphicon-copy"></span> ' . Yii::t('backend', 'Copy'),
            ['create', 'notice_id' => $model->notice_id, 'Notice'=>$copyParams],
    ...
    <?php $this->beginBlock('backend\modules\campus\models\Notice'); ?>
    ...
    <?= Html::a('<span class="glyphicon glyphicon-trash"></span> ' . Yii::t('backend', 'Delete'), ['delete', 'notice_id' => $model->notice_id],
    [
    ...
    <?= Tabs::widget(
                 [
                     ...
                     'items' => [
 [
    'label'   => '<b class=""># '.$model->notice_id.'</b>',
    'content' => $this->blocks['backend\modules\campus\models\Notice'],
    'active'  => true,
],
 ]
                 ]
