...
if (\Yii::$app->user->can('campus_grade_view', ['route' => true])) {
    $actionColumnTemplates[] = '{view}';
}

if (\Yii::$app->user->can('campus_grade_update', ['route' => true])) {
    $actionColumnTemplates[] = '{update}';
}

if (\Yii::$app->user->can('campus_grade_delete', ['route' => true])) {
...
<?php
if(\Yii::$app->user->can('campus_grade_create', ['route' => true])){
?>
        <div class="pull-left">
