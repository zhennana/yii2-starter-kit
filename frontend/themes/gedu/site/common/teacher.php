...
?>
    ...
    <div class="tab-content-fu">
      <div class="tab-content no-padding">
                                ...
                                <div class="item active">
                                    <?php
                                        foreach ($teachers as $key => $value) {
                                            ...
                                            if($key>0&&$key<5){          
                                    ?>
                                    <div class="col-md-3 col-sm-3 col-xs-3 teacher-img" >
                                        <div class="box1">
        ...
        <div class="chart tab-pane" id="primary-chart" style="position: relative;">
          <div class="main-2-teacher">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="chart tab-pane" id="middle-chart" style="position: relative;">
          <div class="main-2-teacher">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="chart tab-pane" id="internation-chart" style="position: relative;">
          <div class="main-2-teacher">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="chart tab-pane" id="speciality-chart" style="position: relative;">
          <div class="main-2-teacher">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
